# Project 2 - SimpleTweet_android

SimpleTweet_android is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://i.imgur.com/B27gSVZ.gif' />
